...
class SppCSPC(nn.Module):
    ...
    def forward(self,x):
        ...
        mp_output4 = self.mp4(output1)
        mp_output5 = self.mp5(output1)

        #合并以上并进行卷积
        result1=self.conv1_2(torch.cat((output1,mp_output4,mp_output1,mp_output2,mp_output3,mp_output5),dim=1))
